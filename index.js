    ...
    .prompt([
      {
        ...
        name: "fullName",
        message:
          "Please enter team's manager name (Required and Alphabets only):",
        validate: (fullName) => {
      ...
      },
      {
        ...
        choices: ["Engineer", "Intern", "Finish buiding my team"],
      },
    ])
    .then((ans) => {
      //console.log(ans);
      let Cretedmang = new mang(
        ans.fullName,
        ans.iden,
        ans.email,
        ans.officeNum
  ...
  inq
    .prompt([
      ...
      },
      {
        ...
        name: "engEmail",
        message:
          "Please enter engineer's email address (Example:smaple@net.com):",
        validate: (engEmail) => {
...
function internQues() {
  inq
    .prompt([
      ...
      },
      {
        ...
        validate: (internEmail) => {
          if (
            /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(internEmail)
          ) {
            return true;
          } else {
    ...
    .then((internAns) => {
      ...
      let createdIntern = new intern(
        internAns.internFullName,
        internAns.internIden,
